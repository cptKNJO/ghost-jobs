...
values
  ...
  ('human', '["100 jobs per month", "Special ''I am human'' label",
   "$0.01 per additional job",
  "7-day trial"]', 'month', 'usd', 200, 400, 'stripe', 'price_1TR8zBKKEkmOtrFM3sEyWis4', 'price_1TR8zBKKEkmOtrFMhKGaoPRR'),
  ('robot', '["500 jobs per month", "Special ''I am robot'' label",
  "$0.01 per additional job",
  "7-day trial"]', 'month', 'usd', 500, 800, 'stripe', 'price_1TR90jKKEkmOtrFMgE8M6i1o', 'price_1TR90jKKEkmOtrFM9YYSlVkW')
