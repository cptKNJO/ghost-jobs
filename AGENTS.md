...
- **/packages/ui**: Shared UI components using ShadCN packages
...
2. **Universal UI**: All components in `packages/ui` must use ShadCN primitives (View, Text, Pressable). Next.js will transpile these for the web.
